...
class APDataObject:
    ...
    def push_false_negative(self, index: int) -> None:
        self.false_negatives.add(index)

    def add_gt_positives(self, num_positives: int) -> None:
...
class ClassedAPDataObject:
    ...
    def push_false_negative(self, class_: int, index: int) -> None:
        self.objs[class_].push_false_negative(index)

    def add_gt_positives(self, class_: int, num_positives: int) -> None:
