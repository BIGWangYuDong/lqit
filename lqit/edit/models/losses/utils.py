...
def mask_reduce_loss(loss: Tensor,
                     weight: Optional[Tensor] = None,
                     reduction: str = 'mean',
                     sample_wise: bool = False) -> Tensor:
    ...
    Note: This is different from the function `weight_reduce_loss`, if weight
          is not None, this function will calculate as
          (loss * weight).sum() / weight.sum().
          While, `weight_reduce_loss` calculate as (loss * weight).mean().
