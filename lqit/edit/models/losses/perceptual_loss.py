...
class PerceptualLoss(nn.Module):
    ...
    Args:
        layer_weights (dict): The weight for each layer of vgg feature for
        ...
        layer_weights_style (dict): The weight for each layer of vgg feature
    ...
    Note: The image should de-normalized before feeding into perceptual loss.
    """
